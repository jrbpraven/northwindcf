		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NorthWind Read-only",
									"targetURL": "#NorthWindReadonly-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NorthWindReadonly-display": {
								"semanticObject": "NorthWindReadonly",
								"action": "display",
								"description": "A Northwind application.",
								"title": "NorthWind Read-only",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sample.northwind.northwind",
									"url": sap.ui.require.toUrl("sample/northwind/northwind")
								}
							}
						}
					}
